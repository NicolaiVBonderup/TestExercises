...
public class JokeTester {
    ...
    public void testCheckIfValidToken() {
        // isStringValid() is visible due to the test class being in the same package.
        // It is using the default modifier, which restricts visibility to its package alone.
